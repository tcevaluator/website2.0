        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t">
            <div className="px-4 py-6 space-y-4">
              ...
              <a href="#comparison" className="block text-gray-700 hover:text-blue-600 transition-colors font-medium">Comparison</a>
              <Link to="/about" className="block text-gray-700 hover:text-blue-600 transition-colors font-medium">About</Link>
              <Link to="/pricing" className="block text-gray-700 hover:text-blue-600 transition-colors font-medium">Pricing</Link>
              <Link to="/book-demo" className="block w-full bg-gray-900 text-center text-white px-6 py-2.5 rounded-lg hover:bg-gray-800 transition-colors font-medium">
                Book a Demo
              </Link>
            </div>
          </div>
