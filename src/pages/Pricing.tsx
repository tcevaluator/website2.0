...
function Pricing() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="pt-44 pb-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-blue-50 to-white">
          ...
          <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
            ...
            <div className="bg-gradient-to-br from-blue-600 to-blue-800 border-2 border-blue-600 rounded-2xl p-6 relative hover:shadow-2xl transition-all flex flex-col">
              ...
              <StripeCheckout
                ...
                priceId={[import.meta.env.VITE_STRIPE_TIER1_PRICE_ID, 'price_1SMcArA5GHv1atYrErzttxnq']}
                buttonText="Get Started"
